...
import ContinueNewAuction from '../components/new auction/ContinueNewAuction';
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          {['Login', 'About',].map((text, index) => (
            <ListItem button key={text}>
              <ListItemIcon>
                {index % 2 === 0 ? <AccountCircleIcon color="action" /> : <InfoIcon color="action" />}
              </ListItemIcon>
              <ListItemText primary={text} />
            </ListItem>
          ))}
        ...
        <Divider />
        <List>
          {['All mail', 'Add Auction'].map((text, index) => (
            <ListItem button key={text}>
              <ListItemIcon>
                {index % 2 === 0 ? <InboxIcon /> : <AddBoxIcon color="action" />}
              </ListItemIcon>
              <ListItemText primary={text} />
            </ListItem>
          ))}
