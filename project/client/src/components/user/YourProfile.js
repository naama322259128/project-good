...
const YourProfile = (props) => {
    ...
    return (
        <Switch>
            <Route path={'/your_profile/edit_auction'}>{props.currentUser.status === 'AUCTION_MANAGER' ? <EditAuction /> : null}</Route>
            <Route path={'/your_profile/statistics'}>{props.currentUser.status === 'AUCTION_MANAGER' ? < AuctionStatistics /> : null}</Route>
            <Route path={'/your_profile/results'}>{props.currentUser.status === 'AUCTION_MANAGER' ? <AuctionResults /> : null}</Route>
